...
namespace GameQUIZZdemo1
{
     public partial class Play7 : Form
     {
          ...
          public Play7(int surNum1 = 60, string nameClient = "", int pointClient = 0,bool sound=true)
          {
               InitializeComponent();
               surNum = surNum1;
               ...
               Text = "Màn 7 - Player: " + name;//ghi tên vòng với tên người chơi
               soundMode = sound;
          }
          ...
          private void pictureBox5_DoubleClick(object sender, EventArgs e)//tắt thuốc lá đi
          {
               Sound(4);
               //submit
          ...
          private void bInstruct_Click(object sender, EventArgs e)
          {
               ...
               if (countInstruct == 1)
               {
                    ...
                    else
                    {
                         ...
                         MessageBox.Show("Kích đúp vào mẩu thuốc lá để tắt", "Đáp án", MessageBoxButtons.OK);
                    }
               }
