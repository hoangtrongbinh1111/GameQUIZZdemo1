...
namespace GameQUIZZdemo1
{
     public partial class Play7 : Form
     {
          ...
          public int point = 0;
          public Play7(int surNum1 = 60, string nameClient = "", int pointClient = 0)
          {
               InitializeComponent();
               surNum = surNum1;
          ...
          {
               DialogResult dlr = MessageBox.Show("Ấn 2 lần vào thuốc lá để dập khói thuốc", "Đáp án", MessageBoxButtons.OK);
               if (dlr == DialogResult.OK)//đồng ý thì reset lại màn chơi
               {
