...
namespace GameQUIZZdemo1
{
     public partial class Play4 : Form
     {
          ...
          public int point = 0;
          public Play4(int surNum1 = 60, string nameClient = "", int pointClient = 0)
          {
               InitializeComponent();
               surNum = surNum1;
          ...
          {
               DialogResult dlr = MessageBox.Show("Hãy kéo mặt trời ra khỏi màn chơi", "Đáp án", MessageBoxButtons.OK);
               if (dlr == DialogResult.OK)//đồng ý thì reset lại màn chơi
               {
